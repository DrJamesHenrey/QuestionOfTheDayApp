...
public class TopicHomeActivity extends Activity {
	String topic;
	User user;
	Section section;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		topicText.setText("Questions for: " + topic);
		...
		for (int i=0; i<questions.size(); i++)
		{
			...
			button.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					Intent myIntent = new Intent(v.getContext(), QestionDetailsActivity.class);
	...
	private void instantiateQuestions() {
		...
		try {
			...
			post.setURI(new URI("http://cse110.courses.asu.edu/index.php/mobile/getQuestionsForSection/" + section.getSectionID()));
