...
public class QestionDetailsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_qestion_details);
...
;
				...
				String result = "You have successfuly deleted the question!";
		...
		edit.setOnClickListener(new View.OnClickListener() 
        {
			...
			public void onClick(View currentView) 
			{
				Intent myIntent = new Intent(currentView.getContext(), CreateQuestionActivity.class);
				myIntent.putExtra("USER_KEY", user);
				myIntent.putExtra("SECTION_KEY", section);
				myIntent.putExtra("QUESTION_KEY", question);
				myIntent.putExtra("EDIT_KEY", true);
				startActivity(myIntent);
			}
        });
