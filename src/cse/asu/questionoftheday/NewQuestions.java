...
public class NewQuestions extends Activity {
	...
	private void initializeQuestions(User user) {
	...
	private void populateButtons(final ArrayList<Question> questions, final User user) {
		...
		if(questions.size()==0)
		{
			questionTit.setText("There are no new questions for you to answer!");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.new_questions, menu);
		return true;
	}
