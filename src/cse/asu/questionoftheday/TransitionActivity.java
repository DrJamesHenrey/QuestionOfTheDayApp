...
public class TransitionActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView transitionText = (TextView) findViewById(R.id.TransitionText);
		...
		String result = (String) getIntent().getExtras().getString("RESULT_KEY");
		transitionText.setText(result);
		...
		transitionButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View currentView) 
			{
				Intent myIntent = new Intent(currentView.getContext(), SectionHomeActivity.class);
