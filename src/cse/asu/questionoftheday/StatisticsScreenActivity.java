...
public class StatisticsScreenActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iv = (ImageView) findViewById(R.id.imageFromServer2);
		//bitmap = getBitmapFromURL("https://cse110.courses.asu.edu/index.php/mobile/transfereGraph");
		bitmap = getBitmapFromURL("https://cse110.courses.asu.edu/jGraph/Pictures/Student_View_Bar_Comparison.png");
	...
	private void initializeStatistics(){
		...
		try{
			...
			post.setURI(new URI("https://cse110.courses.asu.edu/index.php/mobile/getGradesforStudent/" + listOfSections.get(0) + "/"+userid)); 
	...
	public Bitmap getBitmapFromURL(String src){
		try{
			...
			HttpClient defaultClient =  new DefaultHttpClient();
			HttpPost post = new HttpPost();
			post.setURI(new URI("https://cse110.courses.asu.edu/index.php/mobile/transfereGraph" +"/"+ userid+ "/"+ listOfSections.get(0))); 
			HttpResponse httpResponse = defaultClient.execute(post);
			BufferedReader reader = new BufferedReader(new InputStreamReader(httpResponse.getEntity().getContent(), "UTF-8"));
			//
